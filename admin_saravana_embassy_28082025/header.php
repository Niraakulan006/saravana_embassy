                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="images/logo1.webp" alt="Saravana Embassy" height="60">
                            </span>
                            <span class="logo-lg">
                                <img src="images/logo1.webp" alt="Saravana Embassy" height="70">
                            </span>
                        </a>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Saravana Embassy</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">Welcome Saravana Embassy!</h6>
    ...
    <div class="app-menu navbar-menu">
        <div class="navbar-brand-box">
            <a href="dashboard.php" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="images/logo2.webp" alt="Saravana Embassy" height="50">
                </span>
                <span class="logo-lg">
                    <img src="images/logo1.webp" alt="Saravana Embassy" height="50">
                </span>
            </a>
                ...
                <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="collapse menu-dropdown" id="creation">
                            <ul class="nav nav-lg flex-column">
                                <li class="nav-item" id="brand">
                                    <a href="brand.php" class="nav-link"><i class="bi bi-dash"></i> Brand </a>
                                </li>
                                ...
                                <li class="nav-item" id="attributevalue">
                                    <a href="attribute_value.php" class="nav-link"><i class="bi bi-dash"></i> Attribute Value </a>
                                </li>
                                ...
                                <li class="nav-item" id="promocode">
                                    <a href="promo_code.php" class="nav-link"><i class="bi bi-dash"></i> Promo Code </a>
                                </li>
                                <li class="nav-item" id="customer">
                                    <a href="customer.php" class="nav-link"><i class="bi bi-dash"></i> Customer </a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item" id="estimate">
                        <a class="nav-link menu-link" href="estimate.php">
                            <i class="bi bi-receipt"></i><span> Estimate</span>
                        </a>
                    </li>
                    <li class="nav-item" id="ticketrequest">
                        <a class="nav-link menu-link" href="ticket_request.php">
                            <i class="bi bi-ticket-perforated"></i><span> Ticket Request</span>
                        </a>
                    </li>
                    <li class="nav-item" id="closedticket">
                        <a class="nav-link menu-link" href="closed_ticket.php">
                            <i class="bi bi-ticket-perforated-fill"></i><span>Closed Ticket</span>
                        </a>
                    </li>
                    <li class="nav-item" id="techniciantask">
                        <a class="nav-link menu-link" href="technician_task.php">
                            <i class="bi bi-list-task"></i><span>Technician task</span>
                        </a>
                    </li>
                    <li class="nav-item" id="blogs">
                        <a class="nav-link menu-link" href="blogs.php">
                            <i class="bi bi-bookmarks-fill"></i><span>Blogs</span>
                        </a>
                    </li>
                    <li class="nav-item" id="ratings">
                        <a class="nav-link menu-link" href="ratings.php">
                            <i class="bi bi-stars"></i><span>Ratings</span>
                        </a>
                    </li>
                    <li class="nav-item" id="todaytask">
                        <a class="nav-link menu-link" href="today_task.php">
                            <i class="bi bi-clock"></i><span>Today Task</span>
                        </a>
                    </li>
                    <li class="nav-item" id="completedtask">
                        <a class="nav-link menu-link" href="completed_task.php">
                            <i class="bi bi-check-square-fill"></i><span>Completed Task</span>
                        </a>
                    </li>
                    <li class="nav-item" id="pendingtask">
                        <a class="nav-link menu-link" href="pending_task.php">
                            <i class="bi bi-hourglass-bottom"></i><span>Pending Task</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="report">
                            <ul class="nav nav-lg flex-column">
                                ...
                                <li class="nav-item" id="invoicereport">
                                    <a href="invoice_report.php" class="nav-link"><i class="bi bi-dash"></i> Invoice Report </a>
                                </li>
                                <li class="nav-item" id="supportreport">
                                    <a href="support_report.php" class="nav-link"><i class="bi bi-dash"></i> Support Report </a>
                                </li>
                                <li class="nav-item" id="technicianreport">
                                    <a href="technician_report.php" class="nav-link"><i class="bi bi-dash"></i> Technician Report </a>
                                </li>
                                <li class="nav-item" id="customerreport">
                                    <a href="customer_report.php" class="nav-link"><i class="bi bi-dash"></i> Customer Report </a>
                                </li>
