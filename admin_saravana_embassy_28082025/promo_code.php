                                        ...
                                        <div class="row justify-content-end p-2">
                                            <div class="col-lg-3 col-md-4 col-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="search_text" style="height:34px;" placeholder="Search" onKeyUp="Javascript:table_listing_records_filter();" aria-label="Search" aria-describedby="basic-addon2">
