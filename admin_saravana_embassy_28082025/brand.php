                                        ...
                                        <div class="row justify-content-end p-2">
                                            <div class="col-lg-3 col-md-4 col-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" style="height:34px;" placeholder="Search by Brand name" onkeyup="Javascript:table_listing_records_filter();"  name="search_text" aria-label="Search" aria-describedby="basic-addon2">
